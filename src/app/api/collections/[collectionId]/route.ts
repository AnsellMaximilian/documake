...
export async function DELETE(_: Request, { params }: RouteContext<"/api/collections/[collectionId]">) { const { collectionId } = await params; return api((ctx) => deleteCollection(ctx, collectionId)); }
